            ...
            <div class="mb-5">
                <?php foreach ($arResult['AGENTS']['ITEMS'] as $agent) : ?>
                    <div class="agent__card" data-agent-id="<?= $agent['ID']; ?>">
                        ...
                        <?php
                        $avatar_url = !empty($agent['PHOTO_SRC']) ? $agent['PHOTO_SRC'] : $templateFolder . '/images/no-avatar.png';
                        ?>
                        ...
                        <? $isFavorite = empty($arResult['STAR_AGENTS']) === false && in_array($agent['ID'], $arResult['STAR_AGENTS']); ?>
